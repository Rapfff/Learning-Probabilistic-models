...
timed_test_set_1 = loadSet(folder+"timed_test_set_1.txt")
...
timed_test_set_2_disjoint = loadSet(folder+"timed_test_set_2_disjoint.txt")
...
ax.set_xticklabels([1,2,3], ["U||V","U","V"])
