...
from examples.examples_models import modelHMM_random, modelHMM4
...
m2 = modelHMM_random(5,m.observations())
algo = BW_HMM(m2)
m3 = algo.learn(s)
m3.pprint()
...
m2 = modelCOMC_random(2,min_mu=0.0,max_mu=1.0,min_std=0.5,max_std=2.0)
algo = BW_coMC(m2)
m3 = algo.learn(s)
m3.pprint()
