...
NB_STATES = 5
EDF_FILE = "/datasets/10x50_psg/edf_recordings/psg01/edf_data_export.edf"
HYPNO_FILE = "/datasets/10x50_psg/raw_event_exports/01/psg01/xls_events.xls"
...
def find_starting_point(r,frequency):
...
def read_files():
	...
	begining = find_starting_point(r,frequency)
...
data = write_training_test_set(0.0,n_bins=n_bins,n_coefs=n_coefs)
...
algo = BW_HMM(rm)
out = algo.learn(data, verbose=True)
out.pprint()
